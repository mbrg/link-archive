---
date: '2025-12-26'
description: The concept of context graphs presents a transformative opportunity in
  AI-driven enterprise software by capturing decision traces—details on exceptions,
  overrides, and historical context skewed by human judgment. Unlike traditional systems
  of record, which focus on current data, context graphs chronicle why actions were
  taken, enhancing decision-making transparency and audibility. Startups focused on
  this architecture will likely outperform existing players, who struggle with legacy
  limits and data capture post-decision. The evolution towards systems of agents enables
  nuanced decision lineage, fundamentally altering the landscape and value propositions
  for enterprise platforms.
link: https://foundationcapital.com/context-graphs-ais-trillion-dollar-opportunity/
tags:
- Decision Traces
- Enterprise Software
- Systems of Record
- AI
- Context Graphs
title: 'AI’s trillion-dollar opportunity: Context graphs - Foundation Capital'
---

[Go to Main Content](https://foundationcapital.com/context-graphs-ais-trillion-dollar-opportunity/#maincontent)

# **AI’s trillion-dollar opportunity: Context graphs**

12.22.2025 \| By: [Jaya Gupta](https://foundationcapital.com/member/jaya-gupta/), [Ashu Garg](https://foundationcapital.com/member/ashu-garg/)

![](https://foundationcapital.com/nitropack_static/XNDPEdlrGDqXWMQuiSkLqMnwmiFLIXZj/assets/images/optimized/rev-d2ec013/foundationcapital.com/wp-content/uploads/2025/12/The-Trillion-Dollar-Question_Blog-Header-1.jpg)
...
The debate right now is whether those systems survive the shift to agents. Jamin Ball’s recent post “ [Long Live Systems of Record](https://cloudedjudgement.substack.com/p/clouded-judgement-121225-long-live)” hit a nerve. Pushing back on the “agents kill everything” narrative, he argues that agents don’t replace systems of record, they raise the bar for what a good one looks like.
...
_What does this look like in practice?_ A renewal agent proposes a 20% discount. Policy caps renewals at 10% unless a service-impact exception is approved. The agent pulls three SEV-1 incidents from PagerDuty, an open “cancel unless fixed” escalation in Zendesk, and the prior renewal thread where a VP approved a similar exception last quarter. It routes the exception to Finance. Finance approves. The CRM ends up with one fact: “20% discount.”
...
[PlayerZero](https://playerzero.ai/?matchtype=&utm_source=google&utm_medium=cpc&utm_campaign=23361480948&utm_content=&utm_term=&hsa_acc=6526734515&hsa_cam=23361480948&hsa_grp=&hsa_ad=&hsa_src=x&hsa_tgt=&hsa_kw=&hsa_mt=&hsa_net=adwords&hsa_ver=3&gad_source=1&gad_campaignid=23370607165&gbraid=0AAAAABaTSHE2ca_tvJn9RsT1IJaFH_3wo&gclid=Cj0KCQiAjJTKBhCjARIsAIMC44-P3pLng0LsFJ7xbLVAtsAaJAlgiyzjnC3gezNwboiSvZdDlNkGS1YaAkNDEALw_wcB) exemplifies this pattern. Production engineering sits at the intersection of SRE, support, QA, and dev: a classic “glue function” where humans carry context that software doesn’t capture. PlayerZero starts by automating L2/L3 support, but the real asset is the context graph it builds: a living model of how code, config, infrastructure, and customer behavior interact in reality. That graph becomes the source of truth for “why did this break?” and “will this change break production?”: questions no existing system can answer.
...
- [Facebook](https://www.facebook.com/sharer/sharer.php?u=https://foundationcapital.com/)
- [Twitter](https://twitter.com/intent/tweet?url=https://foundationcapital.com//&text=&via=)
- [LinkedIn](https://www.linkedin.com/shareArticle?url=https://foundationcapital.com//&title=)

## Related Stories

[![](<Base64-Image-Removed>)](https://foundationcapital.com/leading-playerzeros-series-a-solving-for-what-happens-when-ai-writes-your-code/)

[Permalink to: Leading PlayerZero’s Series A: Solving for what happens when AI writes your code](https://foundationcapital.com/leading-playerzeros-series-a-solving-for-what-happens-when-ai-writes-your-code/)

[perspective](https://foundationcapital.com/ideas/?categories=perspective)

### Leading PlayerZero’s Series A: Solving for what happens when AI writes your code

By Ashu Garg, Jaya Gupta

[![](<Base64-Image-Removed>)](https://foundationcapital.com/building-the-always-on-finance-team-our-investment-in-maximor/)

[Permalink to: Building the always-on finance team: Our investment in Maximor](https://foundationcapital.com/building-the-always-on-finance-team-our-investment-in-maximor/)

[newsletters](https://foundationcapital.com/ideas/newsletters)

[perspective](https://foundationcapital.com/ideas/?categories=perspective)

### Building the always-on finance team: Our investment in Maximor

By Ashu Garg, Jaya Gupta

[![](<Base64-Image-Removed>)](https://foundationcapital.com/the-4-6t-service-as-software-opportunity-lessons-from-year-one/)

[Permalink to: The $4.6T services as software opportunity: Lessons from year one](https://foundationcapital.com/the-4-6t-service-as-software-opportunity-lessons-from-year-one/)
