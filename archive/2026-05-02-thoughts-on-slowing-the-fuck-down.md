---
date: '2026-05-02'
description: Mario Zechner critiques the rise of coding agents, emphasizing their
  potential to foster software fragility and technical debt. He outlines how rapid
  code generation without oversight leads to compounded errors and poor architecture,
  as agents lack learning mechanisms for refinement. Citing examples of high-profile
  outages and degraded code quality, he warns of the chaos from unregulated agent
  deployment. Advocating a deliberate approach to coding with agents, he suggests
  humans must maintain critical oversight and architectural design to produce robust,
  maintainable systems. The emphasis is on quality over quantity and the necessity
  of human involvement in development.
...
![](https://mariozechner.at/posts/2026-03-25-thoughts-on-slowing-the-fuck-down/media/header.png)The turtle's face is me looking at our industry
