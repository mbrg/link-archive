---
date: '2025-07-21'
description: A security advisory has been released regarding a data leakage vulnerability
  in the now-deprecated Anthropic Slack MCP Server, susceptible to link unfurling
  exploits. This vulnerability allows AI agents to inadvertently exfiltrate sensitive
  data to third-party servers via hyperlink previews. Despite its wide usage, Anthropic's
  MCP servers will not receive further maintenance or patches. Users are advised to
  disable link unfurling in their configurations to mitigate risks and review intent
  and permissions to prevent unauthorized data leakage. This situation highlights
  critical security considerations for AI integrations within enterprise environments.
