---
title: "
     Security Advisory: Anthropic's Slack MCP Server Vulnerable to Data Exfiltration ·  Embrace The Red
  "
tags:
   - prompt-injection
   - data-leakage
...
date: 2025-07-21
description: "Anthropic's deprecated Slack MCP Server contains a critical vulnerability allowing link unfurling, enabling AI agents to exfiltrate sensitive data via prompt injection attacks. With approximately 14k weekly downloads, many installations remain at risk. The flaw permits automatic hyperlink previews, facilitating data leakage to third-party servers. Anthropic has ceased updates or patches, leaving users vulnerable. Security best practices recommend disabling link unfurling via configuration changes to mitigate risks. This incident underlines the pressing need for secure AI deployment in enterprise environments. A thorough inventory of MCP server usage is advisable."
---
