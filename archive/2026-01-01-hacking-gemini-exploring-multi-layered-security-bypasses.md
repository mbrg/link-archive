---
date: '2026-01-01'
description: Valentino Massaro's analysis of Gemini's multi-layered architecture exposes
  significant security vulnerabilities through Markdown sanitizer and image processing.
  Key findings include the ability to bypass sanitization and Content Security Policy
  (CSP) by exploiting the rendering layers in Gemini and Colaboratory applications.
  His exploits demonstrated that indirect prompt injection (IDP) could lead to data
  exfiltration, revealing critical risks in AI systems interacting with untrusted
  input. The report emphasizes the need for robust sanitization mechanisms as complex
  architectures proliferate in AI, reminiscent of early XSS vulnerabilities but with
  new dimensions of exploitation.
link: https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html
tags:
- AI products
- vulnerabilities
- security
- exploitation
- Markdown
title: 'Hacking Gemini: Exploring Multi-Layered Security Bypasses'
---
...
- [bugSWAT Tokyo 2025](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#bugswat-tokyo-hacking-gemini)
  - [Gemini markdown sanitizer bypass](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#gemini-markdown-sanitizer-bypass)
    - [Introduction](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#introduction)
    - [Image rendering process](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#image-rendering-process)
    - [Linkification process](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#linkification-process)
    - [Bypassing the sanitizer](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#bypassing-the-sanitizer)
    - [Bypassing CSP](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#bypassing-csp)
    - [Timeline](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#timeline)
    - [Conclusion](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#conclusion)
  - [Colaboratory markdown sanitizer bypass](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#colaboratory-markdown-sanitizer-bypass)
    - [Introduction](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#introduction-1)
    - [Escaping the Gemini sanitizer](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#escaping-the-gemini-sanitizer)
    - [Confusing Colab](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#confusing-colab)
    - [Bypassing URI prefix](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#bypassing-uri-prefix)
    - [Timeline](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#timeline-1)
    - [Conclusion](https://buganizer.cc/hacking-gemini-a-multi-layered-approach-md.html#conclusion-1)
