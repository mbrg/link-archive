---
date: '2026-06-22'
description: In "Contributor Poker and Zig's AI Ban," Loris Cro discusses the dynamics
  of open source contributions, emphasizing the balance of value and effort in managing
  pull requests (PRs). The concept of "contributor poker" highlights the long-term
  benefits of investing in new contributors, despite initial challenges associated
  with their PRs. Cro advocates for maintaining a trusted contributor ecosystem, directly
  linking this to the decision to ban AI contributions—deeming the associated risks
  outweigh any potential benefits. This strategic approach aims to preserve code quality
  and foster deeper engagement within the Zig Software Foundation community.
...
- Pull Requests
title: Contributor Poker and Zig's AI Ban ◆ Loris Cro's Blog
---
...
/
[Codeberg](https://codeberg.org/kristoff)
...
Contributing to an open source project is an [iterated game](https://en.wikipedia.org/wiki/Repeated_game) and the majority of the value that a contributor can bring to a project lies in the later iterations. In other words, you initially invest some energy (i.e. place a bet) to onboard a new contributor, and you hope that later on that relationship starts paying you back as the contributor becomes more trusted and prolific.
...
[Thanks to contributors like Ryan Liptak](https://www.ryanliptak.com/blog/every-rc-exe-bug-quirk-probably/) Zig users can now enjoy the luxury of setting the executable icon (and more) on Windows because Zig can compile Windows resource script (`.rc`) files.

Another notable example are the contributions from [Frank Denis](https://github.com/jedisct1). I wouldn’t even know where to begin to give a monetary value to the work he has done in `std.crypto`.
...
This is something we have mentioned in our [yearly financial reports](https://ziglang.org/news/2025-financials/), and more importantly it’s an issue we’re actively aware of, and that we hope to solve (or at least mitigate) in the future.
...
If you want to help us succeed, [consider a small monthly donation to the Zig Software Foundation](https://ziglang.org/zsf/).

* * *

[←\\
Simplistic Comptime Column Safety in SQLite Queries](https://kristoff.it/blog/simplistic-comptime-sqlite/)  •  [Scripty\\
→](https://kristoff.it/blog/scripty/)  or  [Back to the Homepage](https://kristoff.it/)

?

**TownSquare**

A tiny shared place for people visiting this site.
...
[townsquare.cauenapier.com](https://townsquare.cauenapier.com/)

you· say something

you [visitingcontributor poker and ai](https://kristoff.it/blog/contributor-poker-and-ai/ "contributor poker and ai")

you [visitingcontributor poker and ai](https://kristoff.it/blog/contributor-poker-and-ai/ "contributor poker and ai")

you [visitingmaintain it with zig](https://kristoff.it/blog/maintain-it-with-zig/ "maintain it with zig")

you [visitingcontributor poker and ai](https://kristoff.it/blog/contributor-poker-and-ai/ "contributor poker and ai")

you [visitingcontributor poker and ai](https://kristoff.it/blog/contributor-poker-and-ai/ "contributor poker and ai")

you [visitingasynchrony is not concurrency](https://kristoff.it/blog/asynchrony-is-not-concurrency/ "asynchrony is not concurrency")
...
_[Join my Discord server](https://discord.com/invite/B73sGxF) to keep chatting._
