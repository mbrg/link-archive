---
date: '2026-01-30'
description: NVIDIA's blog emphasizes the security risks associated with agentic AI
  tools, particularly regarding indirect prompt injection vulnerabilities. The AI
  Red Team advocates for stringent OS-level sandboxing to mitigate risks, including
  enforcing network controls, file write restrictions, and preventing unauthorized
  modifications to configuration files. The recommended security measures—such as
  requiring user approval for network actions, applying tiered access controls, and
  systematic lifecycle management of the sandbox—aim to significantly reduce the attack
  surface. The evolving landscape of AI tools necessitates ongoing assessment of these
  security principles to ensure robust defenses against sophisticated threats.
...
- Sandboxing
- Agentic Workflows
title: Practical Security Guidance for Sandboxing Agentic Workflows and Managing Execution
  Risk ◆ NVIDIA Technical Blog
---
...
[Related Resources](https://developer.nvidia.com/blog/practical-security-guidance-for-sandboxing-agentic-workflows-and-managing-execution-risk/#main-content-end)
...
![](https://developer-blogs.nvidia.com/wp-content/uploads/2025/09/security-techblog-press-1920x1080-1-1024x576-jpg.webp)

Jan 30, 2026


By [Rich Harang](https://developer.nvidia.com/blog/author/rharang/ "Posts by Rich Harang")

0

Like

[Discuss (0)](https://developer.nvidia.com/blog/practical-security-guidance-for-sandboxing-agentic-workflows-and-managing-execution-risk/#entry-content-comments)

- [L](https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fdeveloper.nvidia.com%2Fblog%2Fpractical-security-guidance-for-sandboxing-agentic-workflows-and-managing-execution-risk%2F)
- [T](https://twitter.com/intent/tweet?text=Practical+Security+Guidance+for+Sandboxing+Agentic+Workflows+and+Managing+Execution+Risk+%7C+NVIDIA+Technical+Blog+https%3A%2F%2Fdeveloper.nvidia.com%2Fblog%2Fpractical-security-guidance-for-sandboxing-agentic-workflows-and-managing-execution-risk%2F)
- [F](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdeveloper.nvidia.com%2Fblog%2Fpractical-security-guidance-for-sandboxing-agentic-workflows-and-managing-execution-risk%2F)
- [R](https://www.reddit.com/submit?url=https%3A%2F%2Fdeveloper.nvidia.com%2Fblog%2Fpractical-security-guidance-for-sandboxing-agentic-workflows-and-managing-execution-risk%2F&title=Practical+Security+Guidance+for+Sandboxing+Agentic+Workflows+and+Managing+Execution+Risk+%7C+NVIDIA+Technical+Blog)
- [E](mailto:?subject=I%27d%20like%20to%20share%20a%20link%20with%20you&body=https%3A%2F%2Fdeveloper.nvidia.com%2Fblog%2Fpractical-security-guidance-for-sandboxing-agentic-workflows-and-managing-execution-risk%2F)
...
Based on the [NVIDIA AI Red Team](https://developer.nvidia.com/blog/nvidia-ai-red-team-an-introduction/)’s experience, the following _mandatory_ controls mitigate the most serious attacks that can be achieved with indirect prompt injection:
...
These _recommended_ controls further reduce the attack surface, making host enumeration and exploration more difficult, limiting risks posed by hooks, local MCP configurations, and kernel exploits, and closing other exploitation and disclosure risks.
...
[Agentic AI / Generative AI](https://developer.nvidia.com/blog/category/generative-ai/) \| [Trustworthy AI / Cybersecurity](https://developer.nvidia.com/blog/category/cybersecurity/) \| [General](https://developer.nvidia.com/blog/recent-posts/?industry=General) \| [Intermediate Technical](https://developer.nvidia.com/blog/recent-posts/?learning_levels=Intermediate+Technical) \| [Deep dive](https://developer.nvidia.com/blog/recent-posts/?content_types=Deep+dive) \| [AI Agent](https://developer.nvidia.com/blog/tag/ai-agent/) \| [AI Red Team](https://developer.nvidia.com/blog/tag/ai-red-team/)

## About the Authors

![Avatar photo](https://developer-blogs.nvidia.com/wp-content/uploads/2025/07/cropped-image5-4-131x131.png)
...
[View all posts by Rich Harang](https://developer.nvidia.com/blog/author/rharang/)

## Comments

### Start the discussion at [forums.developer.nvidia.com](https://forums.developer.nvidia.com/t/practical-security-guidance-for-sandboxing-agentic-workflows-and-managing-execution-risk/359179)

- [![](https://developer-blogs.nvidia.com/wp-content/uploads/2026/01/gtc26-drive-reg-kit-email-footer-1360x300-copy.jpg)](https://www.nvidia.com/gtc/?nvid=nv-int-bnr-463583)
- [![](https://developer-blogs.nvidia.com/wp-content/uploads/2026/01/gtc26-training-and-certification-marketing-kit-email-footer-1360x300-copy.jpg)](https://www.nvidia.com/gtc/?nvid=nv-int-bnr-463583)
