---
date: '2025-12-13'
description: The "Resonant Computing Manifesto" advocates for a transformative approach
  to technology that prioritizes human connection and well-being over hyper-scale
  algorithms. Emphasizing five principles—Private, Dedicated, Plural, Adaptable, and
  Prosocial—this movement seeks to create adaptable software ecosystems that enhance
  individual and collective agency. By leveraging AI, technology can provide personalized
  experiences that foster resonance—aligning tools with user values. The manifesto
  is a call to action for technologists to reshape industry norms and create environments
  that enrich human experience, signaling a pivotal shift away from alienation towards
...
![Resonant Computing Artwork](https://resonantcomputing.org/resonance-artwork.png)

_There's a feeling you get_

_in the presence of_

_beautiful buildings and bustling courtyards._

_A sense that these spaces_

_are inviting you to slow down,_

_deepen your attention, and be_

_a bit more human._

_What if our software could do the same?_
...
**_[Sign the manifesto](https://docs.google.com/forms/d/e/1FAIpQLSfzGJX39r_PqGwvCdbE9e4DrhNwSa5GhyLjlzKATnrVNyyEVw/viewform?usp=header)_**

**_[Explore & contribute to the theses of resonant computing](https://docs.google.com/document/d/1ZQcDjzaNQtS8ucpAjSXLaEW1mMbQC8n8-1wrvNnXbgQ/edit?usp=sharing)_**

* * *

## Contributors

_The following individuals drafted and released this manifesto:_
...
[Forest **Stearns**](https://www.draweverywhere.com/)

## Signatories

_The following individuals have signed in support:_
...
_Substantive changes that have been made to this manifesto:_
