...
- context engineering
- OpenAI API
title: You Should Write An Agent · The Fly Blog
---

Author![Thomas Ptacek](https://fly.io/static/images/thomas.webp)Name
 Thomas Ptacek
 @tqbf[@tqbf](https://twitter.com/tqbf)![](https://fly.io/blog/everyone-write-an-agent/assets/agents-cover.webp)Image by [Annie Ruygt](https://annieruygtillustration.com/)
...
## [Anchor](https://fly.io/blog/everyone-write-an-agent/\#its-incredibly-easy) It’s Incredibly Easy
...
This is a trivial engine for an LLM app using the [OpenAI Responses API](https://platform.openai.com/docs/api-reference/responses ""). It implements ChatGPT. You’d drive it with the the obvious loop
...
## [Anchor](https://fly.io/blog/everyone-write-an-agent/\#real-world-agents) Real-World Agents
...
## [Anchor](https://fly.io/blog/everyone-write-an-agent/\#context-engineering-is-real) Context Engineering Is Real
...
## [Anchor](https://fly.io/blog/everyone-write-an-agent/\#nobody-knows-anything-yet-and-it-rules) Nobody Knows Anything Yet And It Rules
